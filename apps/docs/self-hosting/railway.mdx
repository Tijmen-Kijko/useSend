...
<Steps>
  ...
  Create a dedicated least-privilege IAM identity for useSend. Do not use root/admin credentials or the broad `AmazonSNSFullAccess` / `AmazonSESFullAccess` managed policies.
